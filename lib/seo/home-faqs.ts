...
export const HOME_FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Start with a short description of what you want to build, fix, or automate. After a discovery call, you receive a clear scope, technical approach, timeline, and pricing before work begins.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "A focused MVP can often ship in a few weeks depending on scope, integrations, and how quickly requirements are finalized. Larger products take longer. Timeline is agreed upfront.",
  },
  {
